...
def build():
    ...
    # No double hyphen anywhere in this comment: XML forbids it inside a
    # comment, sdformat tolerates it, and a strict parser does not. The
    # generated world was not well formed XML until a test tried to read it.
    header = ("<!-- GENERATED by examples/generate_scene_sdf.py from src/target.py\n"
              ...
              "     the generator with the check flag to confirm it is current.\n\n"
